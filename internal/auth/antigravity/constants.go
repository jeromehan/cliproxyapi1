...
var (
	ClientID     = strings.TrimSpace(os.Getenv("CLIPROXY_ANTIGRAVITY_OAUTH_CLIENT_ID"))
	ClientSecret = strings.TrimSpace(os.Getenv("CLIPROXY_ANTIGRAVITY_OAUTH_CLIENT_SECRET"))
)
